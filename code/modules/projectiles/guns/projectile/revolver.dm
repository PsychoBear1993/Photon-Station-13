...
/obj/item/weapon/gun/projectile/revolver/taurus
	name = "HoS's raging bull"
	desc = "The Raging Bull is a revolver manufactured by the Brazilian Taurus International firearm company. Uses .357 ammo."
	icon_state = "taurus"

/obj/item/weapon/gun/projectile/revolver/taurus/gold
	name = "Golden Bull"
	desc = "The Raging Bull is a revolver manufactured by the Brazilian Taurus International firearm company. Uses .357 ammo."
	icon_state = "taurus-g"

/obj/item/weapon/gun/projectile/revolver/taurus/black
