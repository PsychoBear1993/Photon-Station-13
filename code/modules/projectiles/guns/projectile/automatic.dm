...
/obj/item/weapon/gun/projectile/automatic/evo3
	name = "CZ Scorpion Evo 3"
	desc = "The Scorpion Evo 3 is a Czech 9mm submachine gun."
	icon_state = "evo3"
	item_state = "c20r"
...
/obj/item/weapon/gun/projectile/automatic/evo3/update_icon()
	..()
	icon_state = "evo3[magazine ? "" : "-e"]"
	return
